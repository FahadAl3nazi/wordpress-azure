...
class KeyDesign_Vc_Templates_Panel_Editor {
	...
	public function filters_list() {
			...
			$output .= '<li class="filter active" id="all">All</li>';
				...
				$output .= '<li class="filter" id="Cards">Cards <span class="block-counter">8</span></li>';
				...
				$output .= '<li class="filter" id="Testimonials">Testimonials <span class="block-counter">11</span></li>';
